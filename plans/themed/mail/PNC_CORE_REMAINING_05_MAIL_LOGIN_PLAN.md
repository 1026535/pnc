...
unsuitable. Follow the [common starting-checkpoint rules](../core/PNC_CORE_WORKFLOW_PORTING_PLAN.md#common-starting-checkpoint-and-evidence-rules).
...
| Real captures | [Capture findings](../../reviewed/vision/PNC_NON_YOLO_CAPTURE_FINDINGS_20260913.md): Mail 0010–0018 and native account 0197–0203; no Send or credential submission occurred |
