...
| [PW07 — Observed execution and workflow](packets/PW07_WORKFLOW_EXECUTION.md) | X2a + X1 action session | PW02 + PW04 + PW06 | Delegated | `fearless-sprite` turn 005, base `1f14e06`, authority checkout. Offline action/session/workflow/continuation, actual validator and journal. No unqualified Home→Manor edge and no live invocation before PW05/authority gates. |
