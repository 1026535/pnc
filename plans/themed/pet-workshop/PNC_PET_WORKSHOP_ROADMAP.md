...
Updated: 2026-09-21 UTC. **Workflow resumed by the user; 4/10 packets accepted. PW01 is merged/pushed at 14b7d68; PW03/PW04 at 4f12095; PW06 at 4d39be4. PW02 candidate 4b3926a passed the final offline suite and its popup fix passed live, but storage exposed a recognition/publication crash. Main is released at Home with its original read_only role restored. Follow-up is offline; another live window must be arranged after corrections. PW02 remains unaccepted and gates PW05/PW07. The offline simulator is accepted and merged/pushed at 0724ad7.**
...
| [PW02 — Recognition and controls](packets/PW02_RECOGNITION_CONTROLS.md) | R1 | PW01 | Final board validation in progress | Candidate `b405304`: 2,833 tests passed / 7 environmental skips, plus 5 lead regressions passed. After renewed Main authorization, turn 006 stopped during cold loading after 43 seconds, with only app launch and zero spending; lead verified release/restored role. An evidence-backed readiness correction now has real saved-frame OCR proof and two passing boundary regressions. Turn 007 runs one bounded follow-up without launch/reconnect, storage or Hopeful NPC. Board validation and acceptance remain pending. |
...
| [PW07 — Observed execution and workflow](packets/PW07_WORKFLOW_EXECUTION.md) | X2a + X1 action session | PW02 + PW04 + PW06 | Planned | Consumes actual controls/route evidence, planner/validator and durable boundary. Independent of PW05 reports and live availability. |
