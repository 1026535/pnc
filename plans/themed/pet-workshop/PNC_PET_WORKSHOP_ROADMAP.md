...
| [PW02 — Recognition and controls](packets/PW02_RECOGNITION_CONTROLS.md) | R1 | PW01 | Offline ready; preparing final board validation | Candidate `b405304`: independent correction review found no blocking defects; 2,833 tests passed / 7 environmental skips, plus 5 lead regressions passed. Saved native overlay recognition and invalid energy OCR are fixed. Storage remains outside gameplay and needs no dedicated live visit. A single final-candidate board check remains before merge; its bounded harness is being prepared offline. Main remains released/read_only pending a newly arranged short window. |
