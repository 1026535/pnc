...
[retained navigation evidence](modules/CONTEXT_AND_EVIDENCE.md#navigation-findings-retained-in-these-plans)
...
[Context and evidence](modules/CONTEXT_AND_EVIDENCE.md) extracts useful findings from **Continue non-YOLO recognition** and **Review improve screen recognition**, identifies stale conclusions, and indexes the live tour. No historical resource budget, account selection, agent ownership or approval is imported.
...
|---|---|---|
| [V01](modules/V01_EXISTING_OPENCV_FOUNDATION.md) | Existing OpenCV and observation integration contract | Current baseline |
| [V02](modules/V02_HOME_CAMERA_AND_NAVIGATION.md) | Home camera localization, atlas targets, pan and open | V01 |
| [V03](modules/V03_HOME_APPEARANCES_AND_EVENT_SLOTS.md) | Seasonal references, event occupancy and Sauroi appearance | V02; available variant evidence |
| [V04](modules/V04_INSTITUTE_DEVELOPMENT.md) | Institute, common research tree/detail parsing, Development and queue facts | V01; V02 for automatic Home entry |
| [V05](modules/V05_RESEARCH_ECONOMY.md) | Economy research nodes and details | V04 |
| [V06](modules/V06_RESEARCH_MILITARY.md) | Military research nodes and details | V04 |
| [V07](modules/V07_RESEARCH_FORTIFICATION.md) | Fortification research nodes and details | V04 |
| [V08](modules/V08_ALLIANCE_RESEARCH.md) | Alliance research categories, nodes and donation details | V01; V04's shared node representation if compatible |
| [V09](modules/V09_BAG_SHELL_AND_RESOURCES.md) | Bag tabs, common card contract and Resource inventory | V01 |
...
| [V18](modules/V18_HERO_HALL_AND_RESULTS.md) | Hero Hall menu, saved recruitment results and return | V01; V02 for automatic Home entry |
| [V19](modules/V19_WORLD_PERCEPTION_BRIDGE.md) | Qualified World detector output into current observation/navigation | V01; existing model owner's qualification |
| [V20](modules/V20_BARRACKS_TRAINING.md) | Barracks training and unit information | V01; V02 for Home entry; V16 for shared upgrade/speedup presentation |
| [V21](modules/V21_INFIRMARY_HEALING.md) | Infirmary healing menus | V01; V02 for Home entry; V16 for shared costs/queues |
| [V22](modules/V22_BLACKSMITH_AND_GEAR.md) | Blacksmith hub and Gear inventory | V01; V02 for Home entry; V16 for building upgrade presentation |
| [V23](modules/V23_GEM_AND_SAURGEM.md) | Gem and Saurgem inventories | V22 |
| [V24](modules/V24_WARSIGIL.md) | Warsigil menu and details | V22 |
| [V25](modules/V25_HERO_CURIO.md) | Hero Curio inventory and details | V22 |
| [V26](modules/V26_ASCEND.md) | Ascend menu and requirement details | V22 |
...
| [V34](modules/V34_WALL_DEFENSE.md) | Wall and Defense Info menus | V01; V02 for Home entry; V16 for common upgrade presentation |
| [V35](modules/V35_WATCHTOWER.md) | Watchtower reports and information | V01; V02 for Home entry; V16 for common upgrade presentation |
| [V36](modules/V36_TRAP_WORKSHOP.md) | Trap Workshop and effect tables | V01; V02 for Home entry; V16 for costs/queues and upgrades |
| [V37](modules/V37_ALLIANCE_HALL_REINFORCEMENT.md) | Alliance Hall and reinforcement menus | V01; V02 for Home entry; V16 for building upgrade facts |
| [V38](modules/V38_HALL_OF_WAR.md) | Hall of War and rally information | V01; V02 for Home entry; V16 for upgrade/glory presentation |
| [V39](modules/V39_PIT_RARE_EARTH.md) | Pit and Rare Earth menus | V01; V02 for Home entry |
| [V40](modules/V40_BANK_TREASURE_CAVE.md) | Bank and current Treasure Cave endpoint | V01; V02 for Home entry |
