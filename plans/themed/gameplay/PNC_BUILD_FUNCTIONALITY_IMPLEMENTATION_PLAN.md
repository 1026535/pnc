...
- [open_building_support.py](../../../pnc_automation/app/automation/tasks/open_building_support.py) intentionally accepts only owned buildings and repeatable building ids; it cannot target reserved or flexible source slots.
