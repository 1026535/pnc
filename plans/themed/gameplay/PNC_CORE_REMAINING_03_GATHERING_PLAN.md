...
[V01–V43 scope split](../vision/PNC_CORE_REMAINING_VISION_BOUNDARY.md). A03 owns remaining
Gathering policy, action and caller work. It consumes
[V19](../vision/modules/V19_WORLD_PERCEPTION_BRIDGE.md) for qualified World object
...
[V01](../vision/modules/V01_EXISTING_OPENCV_FOUNDATION.md); do not duplicate either
...
or import dirty peer files. Read the [common starting rules](../core/PNC_CORE_WORKFLOW_PORTING_PLAN.md#common-starting-checkpoint-and-evidence-rules)
...
plans/reviewed/vision/PNC_NON_YOLO_CAPTURE_FINDINGS_20260913.md.
