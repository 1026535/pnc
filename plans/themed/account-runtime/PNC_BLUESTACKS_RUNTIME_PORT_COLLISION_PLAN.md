...
[port-autodetection plan](../../reviewed/account-runtime/PNC_BLUESTACKS_PORT_AUTODETECTION_SUBPLAN.md) and its
[review](../../reviewed/account-runtime/PNC_BLUESTACKS_PORT_AUTODETECTION_REVIEW.md). It does not reopen that migration.
