...
Follow-up: [game-first transition additions](../../reviewed/gameplay/PNC_GAME_FIRST_TRANSITIONS.md) records new routes discovered directly from the running game after this initial implementation, including context-dependent return behavior. Its verification is separate from the initial evidence below.
