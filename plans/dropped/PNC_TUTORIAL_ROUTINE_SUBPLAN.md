...
- [PNC_BUILDING_ACTIONS_SUBPLAN.md](abandoned/PNC_BUILDING_ACTIONS_SUBPLAN.md), which owns the canonical building and linked-screen inventory,
- [PNC_SCREEN_FLOW_ARCHITECTURE.md](PNC_SCREEN_FLOW_ARCHITECTURE.md), which owns reusable navigation guarantees,
...
1. [PNC_BUILDING_ACTIONS_SUBPLAN.md](abandoned/PNC_BUILDING_ACTIONS_SUBPLAN.md) keeps the canonical fact that `sauroi_lair` may expose `sauregg` before tutorial completion and the normal `Sauroi Lair` detail screen after unlock.
