...
- [PNC_TASK_SUBPLAN.md](PNC_TASK_SUBPLAN.md), which owns the broader feature-planning model,
- [PNC_SCREEN_FLOW_ARCHITECTURE.md](PNC_SCREEN_FLOW_ARCHITECTURE.md), which owns reusable navigation and chat-screen access flows,
- [PNC_AUTOMATION_IMPLEMENTATION.md](abandoned/PNC_AUTOMATION_IMPLEMENTATION.md), which remains the primary platform architecture plan.
