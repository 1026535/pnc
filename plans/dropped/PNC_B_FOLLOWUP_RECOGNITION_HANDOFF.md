...
the [active ownership contract](../themed/core/PNC_CORE_WORKFLOW_PORTING_PLAN.md#six-remaining-agent-packages)
...
[A/B coordination](../themed/operations/PNC_AB_COORDINATED_CONTINUATION.md). A's runtime, navigation,
