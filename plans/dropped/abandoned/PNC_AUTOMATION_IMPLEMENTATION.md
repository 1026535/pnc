...
The current repository contains a small ADB spike in [main.py](../../../main.py). It can:
...
accounts:
  - id: account_a
    instance_id: bs-main
    pnc_account_id: REMOVED_SENSITIVE_VALUE
...
The iterative click-mapping and selector-refinement process now lives in [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../../reviewed/vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md).
...
1. [PNC_AUTOMATION_IMPLEMENTATION.md](PNC_AUTOMATION_IMPLEMENTATION.md)
   This primary architecture plan defines ownership, core models, registry rules, and implementation phases.
2. [PNC_AUTOMATION_SUBPLAN.md](PNC_AUTOMATION_SUBPLAN.md)
...
3. [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../../reviewed/vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md)
...
4. [PNC_SCREEN_FLOW_SUBPLAN.md](PNC_SCREEN_FLOW_SUBPLAN.md)
...
5. [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../../reviewed/account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md)
...
6. [PNC_TASK_SUBPLAN.md](../PNC_TASK_SUBPLAN.md)
...
The current `BlueStackController` in [main.py](../../../main.py) currently mixes:
...
This phase is now owned by [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../../reviewed/vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md).
...
This phase is now owned by [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../../reviewed/account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md).
...
- write and refine [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../../reviewed/vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md),
- write and refine [PNC_SCREEN_FLOW_SUBPLAN.md](PNC_SCREEN_FLOW_SUBPLAN.md),
- write and refine [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../../reviewed/account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md),
- write and refine [PNC_TASK_SUBPLAN.md](../PNC_TASK_SUBPLAN.md),
...
- Phase 2: screenshot integration tests plus targeted smoke checks recorded by [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../../reviewed/vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md); future maintenance stays there without reopening the primary phase,
- Phase 2.5: selector screenshot, click-mapping, and smoke evidence recorded by [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../../reviewed/vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md); future maintenance stays there without reopening the primary phase,
- Phase 3: implemented in code and validated by unit tests for runner, script loading, and task contract behavior,
- Phase 4: account-navigation screenshot and smoke evidence recorded by [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../../reviewed/account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md); closure remains pending there until the evidence is complete,
- Phase 5: castle-targeting screenshot and smoke evidence recorded by [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../../reviewed/account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md); closure remains pending there until the evidence is complete,
