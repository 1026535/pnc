...
- [PNC_SCREEN_FLOW_ARCHITECTURE.md](../PNC_SCREEN_FLOW_ARCHITECTURE.md)
...
Future reusable navigation changes should be driven by concrete feature or bug work. When a reusable path is promoted, update [PNC_SCREEN_FLOW_ARCHITECTURE.md](../PNC_SCREEN_FLOW_ARCHITECTURE.md) and the relevant tests instead of reopening this plan.
