...
- [PNC_AUTOMATION_IMPLEMENTATION.md](abandoned/PNC_AUTOMATION_IMPLEMENTATION.md), which remains focused on the primary platform architecture,
- [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../reviewed/account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md), which continues to own bootstrap, login, popup recovery, and castle targeting,
- [PNC_SCREEN_FLOW_ARCHITECTURE.md](PNC_SCREEN_FLOW_ARCHITECTURE.md), which owns canonical reusable navigation,
- [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../reviewed/vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md), which owns selector maturity.
...
- promote genuinely reusable navigation into [PNC_SCREEN_FLOW_ARCHITECTURE.md](PNC_SCREEN_FLOW_ARCHITECTURE.md),
...
- canonical flows required from [PNC_SCREEN_FLOW_ARCHITECTURE.md](PNC_SCREEN_FLOW_ARCHITECTURE.md),
...
- reusable navigation has been promoted into [PNC_SCREEN_FLOW_ARCHITECTURE.md](PNC_SCREEN_FLOW_ARCHITECTURE.md),
...
- add or refine it through [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../reviewed/vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md),
...
This sub-plan should consume shared navigation from [PNC_SCREEN_FLOW_ARCHITECTURE.md](PNC_SCREEN_FLOW_ARCHITECTURE.md). It must not duplicate reusable navigation logic across feature plans.
...
This sub-plan should consume generic task orchestration rules from [PNC_AUTOMATION_SUBPLAN.md](abandoned/PNC_AUTOMATION_SUBPLAN.md). It must not redefine the global task contract, script-runner behavior, or run-level retry policy.

This sub-plan also assumes that account navigation behavior, including login bootstrap and any explicit castle alignment requested by earlier steps, has already been handled by [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../reviewed/account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md).
