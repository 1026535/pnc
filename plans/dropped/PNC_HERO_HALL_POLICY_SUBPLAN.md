...
- [PNC_BUILDING_ACTIONS_SUBPLAN.md](abandoned/PNC_BUILDING_ACTIONS_SUBPLAN.md), which owns Hero Hall as a building surface and its visible tabs/buttons,
- [PNC_TASK_SUBPLAN.md](PNC_TASK_SUBPLAN.md), which owns higher-level task planning,
- [PNC_AUTOMATION_SUBPLAN.md](abandoned/PNC_AUTOMATION_SUBPLAN.md), which owns broader automation architecture.
