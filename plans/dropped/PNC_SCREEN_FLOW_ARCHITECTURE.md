...
- [`ScreenFlowPlanner`](../../pnc_automation/app/pnc/navigation/screen_flows.py)
...
This follows the boundary in [PNC_WORLD_MAP_SEARCH_SUBPLAN.md](../reviewed/world-map/PNC_WORLD_MAP_SEARCH_SUBPLAN.md) and [PNC_SPATIAL_SURFACE_SUBPLAN.md](../reviewed/vision/PNC_SPATIAL_SURFACE_SUBPLAN.md).
...
- [PNC_SCREEN_FLOW_SUBPLAN.md](abandoned/PNC_SCREEN_FLOW_SUBPLAN.md) is closed and points here.
- [PNC_TASK_SUBPLAN.md](PNC_TASK_SUBPLAN.md) consumes screen flows from feature slices.
- [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../reviewed/account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md) consumes bootstrap, popup recovery, and castle targeting flows.
- [PNC_SPATIAL_SURFACE_SUBPLAN.md](../reviewed/vision/PNC_SPATIAL_SURFACE_SUBPLAN.md) owns fixed-selector, dynamic-list, and spatial-surface observation boundaries.
- [PNC_WORLD_MAP_SEARCH_SUBPLAN.md](../reviewed/world-map/PNC_WORLD_MAP_SEARCH_SUBPLAN.md) owns world-map-local search and traversal.
- [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../reviewed/vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md) owns selector maturity needed by flow actions.
- [PNC_MAIL_WORKFLOW_IMPLEMENTATION.md](../reviewed/mail/PNC_MAIL_WORKFLOW_IMPLEMENTATION.md) records the mail/profile routes that are now promoted into `ScreenFlowPlanner`.
- [PNC_CHAT_WORKFLOW_SUBPLAN.md](../reviewed/chat/PNC_CHAT_WORKFLOW_SUBPLAN.md) records the chat routes that are now promoted into `ScreenFlowPlanner`.
