...
- [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md), which owns reusable screen-flow boundaries,
- [PNC_SELECTOR_RESOLUTION_SUBPLAN.md](../vision/PNC_SELECTOR_RESOLUTION_SUBPLAN.md), which owns the generic observed-selector fallback model.
