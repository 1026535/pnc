...
- one script model under [scripts/](../../../scripts),
...
This feature should be treated as one dedicated post-navigation feature slice under [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md).

It should consume reusable navigation from [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md) rather than duplicating chat-opening or root-return logic.
...
Add one routine script under [scripts/routines/](../../../scripts/routines):
...
This is the exact kind of reusable flow that belongs in [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md).
...
- [scripts/routines/kingdom_chat_heartbeat.yaml](../../../scripts/routines/kingdom_chat_heartbeat.yaml)
