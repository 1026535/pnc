...
- [mail.py](../../../pnc_automation/app/pnc/domain/mail.py)
- [send_mail_task.py](../../../pnc_automation/app/automation/tasks/send_mail_task.py)
- [api.py](../../../pnc_automation/app/entrypoints/api.py)
...
- one canonical task id model in [task.py](../../../pnc_automation/app/automation/engine/task.py),
- one canonical task registry in [registry.py](../../../pnc_automation/app/authoring/scripts/registry.py),
- one script model and loader in [models.py](../../../pnc_automation/app/authoring/scripts/models.py) and [loader.py](../../../pnc_automation/app/authoring/scripts/loader.py),
- one script runner in [script_runner.py](../../../pnc_automation/app/automation/engine/script_runner.py),
- one application wiring layer in [app.py](../../../pnc_automation/app/entrypoints/app.py),
- one CLI entry point in [cli.py](../../../pnc_automation/app/entrypoints/cli.py),
- one Python convenience API in [api.py](../../../pnc_automation/app/entrypoints/api.py),
- one canonical `send_mail` task implementation in [send_mail_task.py](../../../pnc_automation/app/automation/tasks/send_mail_task.py).
...
- extend [models.py](../../../pnc_automation/app/authoring/config/models.py) so `AppConfig` can carry the resolved mail-definition and mail-schedule paths and loaded authoring catalog,
- extend [loader.py](../../../pnc_automation/app/authoring/config/loader.py) so sibling defaults resolve to:
  - `config/mail_definitions.yaml`
  - `config/mail_schedules.yaml`
...
Extend [cli.py](../../../pnc_automation/app/entrypoints/cli.py) with two direct commands:
...
[api.py](../../../pnc_automation/app/entrypoints/api.py) already exposes canonical direct mail helpers. That surface should be preserved and expanded.
...
- [loader.py](../../../pnc_automation/app/authoring/config/loader.py)
- [models.py](../../../pnc_automation/app/authoring/config/models.py)
- [script_runner.py](../../../pnc_automation/app/automation/engine/script_runner.py)
- [app.py](../../../pnc_automation/app/entrypoints/app.py)
- [api.py](../../../pnc_automation/app/entrypoints/api.py)
- [cli.py](../../../pnc_automation/app/entrypoints/cli.py)
- [mail.py](../../../pnc_automation/app/pnc/domain/mail.py)
