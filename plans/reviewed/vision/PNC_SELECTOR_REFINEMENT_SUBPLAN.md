...
- [PNC_AUTOMATION_IMPLEMENTATION.md](../../dropped/abandoned/PNC_AUTOMATION_IMPLEMENTATION.md), which remains the primary platform architecture plan,
- [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md), which covers account-specific bootstrap and castle-targeting behavior,
- [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md), which covers concrete task behavior,
- [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md), which covers reusable navigation flows,
- [PNC_SPATIAL_SURFACE_SUBPLAN.md](PNC_SPATIAL_SURFACE_SUBPLAN.md), which covers scrollable world-map and home-city spatial-surface modeling,
- [PNC_AUTOMATION_SUBPLAN.md](../../dropped/abandoned/PNC_AUTOMATION_SUBPLAN.md), which covers orchestration.

This file owns the detailed work for former Phase 2 and Phase 2.5 from [PNC_AUTOMATION_IMPLEMENTATION.md](../../dropped/abandoned/PNC_AUTOMATION_IMPLEMENTATION.md).
...
- world-map fixed overlay selectors and spatial-surface parser fixtures requested by [PNC_SPATIAL_SURFACE_SUBPLAN.md](PNC_SPATIAL_SURFACE_SUBPLAN.md),
...
This sub-plan refines the registry defined in [PNC_AUTOMATION_IMPLEMENTATION.md](../../dropped/abandoned/PNC_AUTOMATION_IMPLEMENTATION.md). It must not create a parallel selector-definition system.
...
- [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md) must consume account-navigation-related selectors only after they are sufficiently refined here.
- [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md) must consume selectors only after the required selectors are sufficiently refined.
- [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md) must reference the refined selectors for reusable navigation flows.
- [PNC_SPATIAL_SURFACE_SUBPLAN.md](PNC_SPATIAL_SURFACE_SUBPLAN.md) must request fixed overlay selector maturity and parser-fixture increments here rather than redefining registry ownership.
- [PNC_AUTOMATION_SUBPLAN.md](../../dropped/abandoned/PNC_AUTOMATION_SUBPLAN.md) must not redefine refinement rules; it only consumes the resulting registry quality level.
