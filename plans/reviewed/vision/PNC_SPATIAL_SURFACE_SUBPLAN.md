...
- [PNC_AUTOMATION_IMPLEMENTATION.md](../../dropped/abandoned/PNC_AUTOMATION_IMPLEMENTATION.md), which remains the primary architecture plan,
- [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](PNC_SELECTOR_REFINEMENT_SUBPLAN.md), which owns selector maturity and registry refinement,
- [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md), which owns reusable navigation flows,
- [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md), which owns bootstrap and castle targeting,
- [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md), which owns bounded feature/task slices.
...
This plan does not replace [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md). It defines the missing architecture that those flows should consume.
...
This plan does not replace [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md). It defines the missing observation/runtime layer those tasks should consume.
...
This plan depends on [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](PNC_SELECTOR_REFINEMENT_SUBPLAN.md) and refines its ownership boundary.
...
- [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](PNC_SELECTOR_REFINEMENT_SUBPLAN.md) should request and validate the fixed overlay selectors and parser fixtures required here.
- [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md) should own the reusable flows that consume this spatial model.
- [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md) should consume this spatial model for gathering and Lord Info from world map, while home-city building work should be specified by a dedicated follow-on plan.
- [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](../account-runtime/PNC_ACCOUNT_NAVIGATION_SUBPLAN.md) should continue using only the reusable flows and selectors it actually needs.
