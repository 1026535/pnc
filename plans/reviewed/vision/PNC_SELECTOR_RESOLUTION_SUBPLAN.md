...
- [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](PNC_SELECTOR_REFINEMENT_SUBPLAN.md), which owns selector discovery and registry maturity,
...
- [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md), which owns bounded feature-task behavior.
