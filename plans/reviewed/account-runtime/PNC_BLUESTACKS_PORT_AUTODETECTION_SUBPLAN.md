...
- [PNC_ACCOUNT_NAVIGATION_SUBPLAN.md](PNC_ACCOUNT_NAVIGATION_SUBPLAN.md), which owns login and castle-targeting behavior after a session exists,
- [PNC_KINGDOM_CHAT_MONITOR_IMPLEMENTATION.md](../chat/PNC_KINGDOM_CHAT_MONITOR_IMPLEMENTATION.md), which owns the Kingdom Chat monitor itself.
...
- one new resolver-focused test module under [tests](../../../tests)
