...
- [PNC_AUTOMATION_SUBPLAN.md](../../dropped/abandoned/PNC_AUTOMATION_SUBPLAN.md), which covers generic orchestration,
- [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md), which covers selector maturity,
- [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md), which covers reusable navigation,
- [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md), which covers post-navigation task behavior.
...
Account-navigation work should consume shared navigation flows from [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md), especially:
...
- [PNC_AUTOMATION_SUBPLAN.md](../../dropped/abandoned/PNC_AUTOMATION_SUBPLAN.md) owns generic runner and orchestration behavior and should consume these tasks.
- [PNC_SELECTOR_REFINEMENT_SUBPLAN.md](../vision/PNC_SELECTOR_REFINEMENT_SUBPLAN.md) owns account-navigation-related selector maturity and click validation.
- [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md) owns reusable navigation shared by bootstrap, castle targeting, and later tasks.
- [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md) starts after account/session preparation has been verified and must not duplicate account-navigation task design.
