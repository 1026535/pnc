...
- [PNC_RUNTIME_CASTLE_TARGETING_SUBPLAN.md](PNC_RUNTIME_CASTLE_TARGETING_SUBPLAN.md), which owns the current single-target runtime castle contract,
- [PNC_TASK_SUBPLAN.md](../../dropped/PNC_TASK_SUBPLAN.md), which owns feature-task planning,
- [scripts/README.md](../../../scripts/README.md), which owns the public authored-script guidance.
...
- one example routine under [scripts/routines/](../../../scripts/routines),
