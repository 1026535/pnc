...
- [PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md), which should own only screen-to-screen navigation such as Home City to World Map or World Map to Campaign,
- [PNC_SPATIAL_SURFACE_SUBPLAN.md](../vision/PNC_SPATIAL_SURFACE_SUBPLAN.md), which owns the world-map spatial observation model,
- [PNC_SPATIAL_MAP_LOGGING_AND_ARTIFACT_POLICY_SUBPLAN.md](../vision/PNC_SPATIAL_MAP_LOGGING_AND_ARTIFACT_POLICY_SUBPLAN.md), which owns routine artifact/debug persistence policy,
- [PNC_MARCH_MANAGEMENT_SUBPLAN.md](../../dropped/PNC_MARCH_MANAGEMENT_SUBPLAN.md), which should consume map search instead of redefining it,
- [PNC_RELICS_SUBPLAN.md](../../dropped/PNC_RELICS_SUBPLAN.md), which may later consume the same precise world-map search capabilities.
...
[PNC_SCREEN_FLOW_SUBPLAN.md](../../dropped/abandoned/PNC_SCREEN_FLOW_SUBPLAN.md) should be updated conceptually by this document, not expanded to own viewport traversal.
...
[PNC_SPATIAL_SURFACE_SUBPLAN.md](../vision/PNC_SPATIAL_SURFACE_SUBPLAN.md) remains the owner of:
...
[PNC_SPATIAL_MAP_LOGGING_AND_ARTIFACT_POLICY_SUBPLAN.md](../vision/PNC_SPATIAL_MAP_LOGGING_AND_ARTIFACT_POLICY_SUBPLAN.md) remains the owner of routine artifact selection.
