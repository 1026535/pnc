...
class VisualScreenMetadataTests(unittest.TestCase):
    ...
    def test_all_profiles_match_the_frozen_reference_manifest(self) -> None:
        ...
        self.assertEqual(34, len(catalog["profiles"]))
        ...
        self.assertEqual(34, len(recognizer.profiles))
        ...
        self.assertEqual(29, len({item.screen_type for item in recognition.evidence}))
        self.assertTrue(
            all(
