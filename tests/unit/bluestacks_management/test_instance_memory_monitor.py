...
Cohesion exception: one memory-monitor recovery state machine shares fake host
samples across thresholds, durable intent, cooldown, revocation, and failures.
"""
