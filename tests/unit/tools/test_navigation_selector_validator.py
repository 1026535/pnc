...
Cohesion exception: one selector-validation evidence contract shares fake captures
across prerequisite navigation, delayed destinations, popups, and report failures.
"""
