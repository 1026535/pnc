...
Cohesion exception: selector discovery's image/OCR-to-evidence pipeline uses one
synthetic capture fixture across selector states and diagnostic reports.
"""
