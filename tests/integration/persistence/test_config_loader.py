...
Cohesion exception: one YAML-to-AppConfig validation matrix shares filesystem
fixtures for credentials, paths, defaults, castle rosters, and role policies.
"""
...
from pnc_automation.app.pnc.domain.castles import CastleRosterOrdering
from pnc_automation.app.authoring.config.models import CredentialSource, LiveAutomationRole
