"""Cohesion exception: one bounded popup-recovery state machine shares synthetic
observations across updates, launch transitions, deduplication, and exhaustion.
"""
