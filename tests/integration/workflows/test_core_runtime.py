...
Cohesion exception: one core runtime transition contract shares a fake clock and
navigation harness across settling, observation budgets, and terminal outcomes.
"""
