...
Updated: 2026-09-16. Status: **V01/V09 integrated; V02 accepted after architectural review and live proof; V04 integration/live validation and V13 implementation active.**
...
| V04 | Implemented, review candidate | `codex/vision-v04-research`, integrated with V02 `55d3d7f` | Second Devin worker implemented typed Research producers, geometry-first rows, matching detail, queue facts and core/caller integration; lead review corrections R1–R5 completed typed provenance, selection-proof separation, honest clipped/unreadable geometry, per-observation prepared-frame reuse and portable acceptance coverage. Reviewed Home entry is now integrated; the bounded non-spending live route is pending before accepted merge/push. |
