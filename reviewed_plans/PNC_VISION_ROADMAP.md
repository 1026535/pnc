...
Updated: 2026-09-16. Status: **V01/V02/V04/V09 integrated; V13 implementation active, V15 review candidate pending lead review and live proof, V16 implementation next.**
...
| V15 | Review candidate | Base `0dcc68d`; candidate `codex/vision-v15-trial` | Typed six-card Trial facts, toolbar counter and Gear-only measured Stats action through both publishers; bounded Applicable Stats detail (nine rows + footer category); `open_trial_stats` constrained to the proved Gear read-only family with the lead-reviewed Back edge. Focused unit/integration/navigation checks passed; final lead review and non-spending live Gear Stats route proof remain. Other categories publish facts but stay unsupported for inspection; no trial/battle/claim action. See V15 for evidence and scoped limits. |
