...
Status (2026-09-12): implementation resumed. Published feature tip `b2af988` contains the reviewed integration through `c7dfdd5`; the current continuation merges mainline `15845b8`. Remaining F family evidence and live promotion gates are incomplete. This document does not authorize game mutations.
