...
| [PW03 — Effort, reservations and policy](pet_workshop_packets/PW03_EFFORT_RESERVATIONS_POLICY.md) | S1 | PW01 | Fixing findings | Lead reviewed `a9f79ae`; 129 focused tests passed but counterexamples failed. Recovered `absorbing-vicuna` turn 003 from rebased `32197aa` handles routine S1/S5; lead owns unresolved recipe/allocation S3/S4/S6. Not accepted. |
| [PW04 — One-step solver](pet_workshop_packets/PW04_ONE_STEP_SOLVER.md) | S2 | PW03 policy implementation | Fixing findings | Same recovered solver turn handles S2 and its regression scenarios. Final combined candidate checks await the lead-owned recipe fixes; pure solver has no live dependency. |
