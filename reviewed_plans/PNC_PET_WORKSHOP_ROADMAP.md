...
| [PW03 — Effort, reservations and policy](pet_workshop_packets/PW03_EFFORT_RESERVATIONS_POLICY.md) | S1 | PW01 | Delegated | Accepted base `91afce6`; `absorbing-vicuna` turn 001 in `pet-workshop-solver`. Canonical pure policy/effort/validator. |
| [PW04 — One-step solver](pet_workshop_packets/PW04_ONE_STEP_SOLVER.md) | S2 | PW03 policy implementation | Delegated | Same solver worker continues after tested PW03; combined lead-review handoff, no recognition dependency. |
