...
Focused authored-dispatch validation passed 61 tests. The full portable gate `tools/run_tests.py full --json .test-impact/open-building-integration-selection.json --results .test-impact/open-building-integration-results.json` reported succeeded=true with 1,527 passed tests and five optional fixture skips (1,532 total), using source `9c104d72d173604cfed0e80d5a268c2df8035bac` and fingerprint `e3bf0c007e3c754ac0cee2edef011d6fd2599301c0f4d90c84eac2d8effdf9a9`.

Root's live result `.local-data/artifacts/replacement_core/open_building_script_result.json` confirmed a typed `CoreStepRunResult` reaching exact `PNC_CASTLE`, with building frame `artifacts/2026-09-12/serious_stuff/20260912T173824Z_core_20260912T173606Z_481270fa_0034_core_10_building_after_1.png` and trace `artifacts/2026-09-12/serious_stuff/20260912T173606Z_481270fa_core_trace.jsonl`. Explicit caller recovery returned Home in `artifacts/2026-09-12/serious_stuff/20260912T173839Z_core_20260912T173829Z_8fda0b37_0004_core_1_after_1.png`, with recovery trace `artifacts/2026-09-12/serious_stuff/20260912T173829Z_8fda0b37_core_trace.jsonl`. The proof reused one continuous `serious_stuff` lease and performed no castle selection, message, or resource action. The binding is not yet claimed merged while the recognition owner lands newer main and root coordinates synchronization.
