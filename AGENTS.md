...
- Record every castle-identity, popup, or BlueStacks instance-management failure in the live-test batch, including incidents recovered during the run: artifact, failed boundary, recovery action, outcome, and follow-up owner. Classify unrelated popup, navigation, lease, castle-identity, or target-setup failures at the boundary where they occurred. Finish other safe independent checks and continue offline development. Keep affected live cases pending until their own postconditions are observed; an environmental failure is neither a feature failure nor passing proof. Never bypass lease or identity authority to get a result.
