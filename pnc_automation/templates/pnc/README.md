...
`pnc_home_right_rail_gift_center_icon.png` is the interior of the blue/gold Gift Center shortcut, excluding its notification badge and background. It was cropped from the active testing castle's 900 × 1600 capture at `.local-data/artifacts/2026-09-10/testing/20260910T204524Z_navigation_validation_1_before_case_1_post_action_1.png` and confirmed by the live Gift Center navigation report under `.local-data/artifacts/navigation_audit/repaired/`.
