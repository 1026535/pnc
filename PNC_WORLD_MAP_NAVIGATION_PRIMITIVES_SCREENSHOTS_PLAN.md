# PNC World-Map Navigation Primitives Screenshot Plan

## Purpose

List the screenshots needed to implement and validate:

- `WorldMapCoordinateNavigator`
- `WorldMapOverviewNavigator`

This supports `PNC_WORLD_MAP_NAVIGATION_PRIMITIVES_PLAN.md`.
