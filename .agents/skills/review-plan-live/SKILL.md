...
5. Reuse evidence that passes the live skill's readiness gate. When material current-runtime questions remain, run one coherent exploration session covering the connected questions; follow [../test-bluestacks-live/SKILL.md](../test-bluestacks-live/SKILL.md).
...
- Stop before state-changing work outside authorized exploration. Canaries, protected or irreversible actions, unattended execution, and uncertain retries require the strict action, target, resource, and attempt limits in the live skills.
